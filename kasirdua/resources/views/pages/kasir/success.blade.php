                    ...
                    <div class="card-body py-5 px-5">
                        ...
                        <div class="row mt-2">
                            <div class="col-7">
                                ...
                                <p class="mb-0 text-secondary fs-7">{{number_format($item->price)}}</p>
                            </div>
                            <div class="col-5">
                                <p class="mb-0 text-dark text-end fw-semibold">Rp {{number_format($item->price * $item->quantity)}}</p>
                                <p class="mb-0 text-secondary text-end fs-7">{{number_format($item->quantity)}}x</p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-2">
                            ...
                            <p class="mb-0 text-dark fw-semibold">Rp {{number_format($transaction->subtotal)}}</p>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-2">
                            <p class="mb-0 text-secondary">Pajak</p>
                            <p class="mb-0 text-dark fw-semibold">Rp {{number_format ($transaction->subtotal * ($transaction->pax/100))}}</p>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-2">
                            <p class="mb-0 text-secondary">Total</p>
                            <p class="mb-0 text-dark fw-semibold">Rp {{number_format($transaction->subtotal + ($transaction->subtotal * ($transaction->pax/100)) )}}</p>
                        </div>
                        <hr class="my-4" style="border-style: dashed;">
                        <div class="d-flex align-items-center justify-content-between mt-2">
                        ...
                        <a href="{{route('kasir.print', $transaction->id)}}" target="_blank" class="btn btn-secondary d-block mt-5">cetak
